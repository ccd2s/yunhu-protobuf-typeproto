...
export const PWssBase = ProtoMessage.of({
  /** 消息 ID */
...
export const PWssHeartbeat = ProtoMessage.of({
  base: ProtoField(1, PWssBase)
});

export const PWssPushMessageTag = ProtoMessage.of({
...
export const PWssPushMessageSender = ProtoMessage.of({
  ...
  /** 标签 */
  tag: ProtoField(7, PWssPushMessageTag, "repeated")
});

export const PWssPushMessageCmd = ProtoMessage.of({
  /** 命令ID */
...
export const PWssPushMessageContent = ProtoMessage.of({
  /** 消息内容 */
...
export const PWssPushMessageMsg = ProtoMessage.of({
  /** 消息 ID */
  msgId: ProtoField(1, "string"),
  /** 发送者,编辑消息无此项 */
  sender: ProtoField(2, PWssPushMessageSender),
  /** 接收者ID */
...
export const PWssPushMessageData = ProtoMessage.of({
  any: ProtoField(1, "string"),
  value: ProtoField(2, PWssPushMessageMsg)
});

export const PWssPushMessage = ProtoMessage.of({
  base: ProtoField(1, PWssBase),
  data: ProtoField(2, PWssPushMessageData)
});

/** 草稿详情 */
export const PWssDraft = ProtoMessage.of({
  chatId: ProtoField(1, "string"),
  input: ProtoField(2, "string")
});

/** Data 数据层 */
export const PWssDraftInputData = ProtoMessage.of({
  any: ProtoField(1, "string"),
  value: ProtoField(2, PWssDraft)
});

/** 主消息结构 */
export const PWssDraftInput = ProtoMessage.of({
  base: ProtoField(1, PWssBase),
  data: ProtoField(2, PWssDraftInputData)
});

/** 看板 */
export const PWssBotBoard = ProtoMessage.of({
...
/** Data 数据层 */
export const PWssBotBoardMessageData = ProtoMessage.of({
  any: ProtoField(1, "string"),
  value: ProtoField(2, PWssBotBoard)
});

/** 主消息结构 */
export const PWssBotBoardMessage = ProtoMessage.of({
  base: ProtoField(1, PWssBase),
  data: ProtoField(2, PWssBotBoardMessageData)
});
